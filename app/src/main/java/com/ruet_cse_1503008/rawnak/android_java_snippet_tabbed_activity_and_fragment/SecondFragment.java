...
import com.ruet_cse_1503008.rawnak.android_java_snippet_tabbed_activity_and_fragment.bottom_navigation.OptionsMinCgpaActivity;
...
public class SecondFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonNextActivity = root.findViewById(R.id.buttonNextActivity);

        buttonNextActivity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getActivity().getApplicationContext(), OptionsMinCgpaActivity.class);
                startActivity(i);
            }
        });
